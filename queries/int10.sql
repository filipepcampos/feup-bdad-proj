...
-- [Descrição]
-- Mostrar mensagens num formato facil de ler, isto é, mostrar o username dos utilizadores em vez do id e
-- mostrar a data formatada em vez do valor unixepoch
